# 2-intro-to-git-part-1-commit-changes
...
If you already created a Django project from [Article 1](https://github.com/binanhphuoc/IPS-Docs/tree/f2bfd0337aec3f534738e0f0003065c66d437b3f/Guides/1-set-up-python-dev-env.html), you can move on to [Step 2](2-intro-to-git-part-1-commit-changes.md#4.1.2). Otherwise, you can download a sample Django project folder in the following link:
...
![](../.gitbook/assets/2-4.3-1-make_changes%20%281%29.png)
...
![](../.gitbook/assets/2-4.3-3-git_log%20%281%29.png)
...
![](../.gitbook/assets/2-4.4-2-git_log%20%281%29.png)
