...
![](../.gitbook/assets/2-2.2.1-2-second_commit_node.png)
...
![](../.gitbook/assets/2-2.2.1-3-third_commit_node%20%283%29.png)
...
![](../.gitbook/assets/2-2.2.1-6-git_checkout_master%20%282%29.png)
...
If you already created a Django project from [Article 1](https://github.com/binanhphuoc/IPS-Docs/tree/39342afbeb152f96aa7eae9c54a2cebd2198a49f/Guides/1-set-up-python-dev-env.html), you can move on to [Step 2](2-intro-to-git-part-1-commit-changes.md#4.1.2). Otherwise, you can download a sample Django project folder in the following link:
...
![](../.gitbook/assets/2-4.1-1-git_init%20%281%29.png)
...
![](../.gitbook/assets/2-4.1-2-git_init_2%20%282%29.png)
...
![](../.gitbook/assets/2-4.2-2-git-commit%20%283%29.png)
...
![](../.gitbook/assets/2-4.3-1-make_changes%20%282%29.png)
...
![](../.gitbook/assets/2-4.4-1-git_checkout%20%283%29.png)
