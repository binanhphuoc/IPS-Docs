...
![](../.gitbook/assets/2-4.2-3-git-log%20%282%29.png)
...
![](../.gitbook/assets/2-4.3-1-make_changes.png)

Now, if you type `git status`, Git will say that it sees some changes like this:

![](../.gitbook/assets/2-4.3-2-git_status%20%282%29.png)
...
![](../.gitbook/assets/2-4.4-2-git_log%20%282%29.png)
